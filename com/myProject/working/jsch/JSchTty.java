 ...
 * 
 */
package com.myProject.working.jsch;
...
import com.myProject.working.Questioner;
import com.myProject.working.Tty;
import com.myProject.working.swing.standalone.MainPgrm;
...
public class JSchTty implements Tty { 
	...
	public boolean init(Questioner q){
		...
		try {
			...
			MainPgrm.logger.error("Error opening channel",e);
			return false;
		} catch (final JSchException e) {
			q.showMessage(e.getMessage());
			MainPgrm.logger.error("Error opening session or channel",e);
			return false;
		}
	}
